These files are a bunch of source files I copied out of my SDK project. Honestly,
I have no idea which files I really need, and I doubt that this is enough for 
anyone to recreate my program. The SDK tries to make your life easier with the
philosophy that you shouldn't have to think about anything. But you see, now that
I want to somehow share my code, I can't do it! There are like 10000 include files,
and a bunch of hidden configuration files....

But on the other hand, for some reason I felt compelled to put it in the repo anyway.
